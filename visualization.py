...
def plot_training_progress(progress):
    ...
    # Ajouter la trace de la récompense
    fig.add_trace(
        go.Scatter(
            x=progress['epochs'],
            y=progress['rewards'],
    ...
    # Ajouter la trace de l'énergie économisée
    fig.add_trace(
        go.Scatter(
            x=progress['epochs'],
    ...
    # Mettre à jour l'axe y secondaire
    fig.update_yaxes(title_text="Énergie économisée (%) / Perte", secondary_y=True)
